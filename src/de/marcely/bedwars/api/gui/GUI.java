...
public class GUI extends SimpleGUI implements Clickable {
   ...
   public GUI(String var1, int var2) {
      this.title = var1;
      this.height = var2;
   ...
   public boolean addItem(GUIItem var1) {
      return this.addItem(var1, (GUI.AddItemFlag)null);
   }

   public boolean addItem(GUIItem var1, @Nullable GUI.AddItemFlag var2) {
      int var4;
      int var5;
      label69: {
         var1.gui = this;
   ...
   public void centerAtY(int var1, GUI.CenterFormatType var2, int var3, int var4) {
      ...
      for(var6 = 0; var6 < var5.size(); ++var6) {
         ...
         int var8 = -1;
         if (var2 == GUI.CenterFormatType.Normal) {
            var8 = GUI_Style.getSlotCenter_Normal(var6, var5.size(), var3, var4);
         } else if (var2 == GUI.CenterFormatType.Beautiful) {
   ...
   public void centerAtX(int var1, GUI.CenterFormatType var2, int var3, int var4) {
      ArrayList var5 = new ArrayList();
   ...
   public void centerAtY(int var1, GUI.CenterFormatType var2) {
      this.centerAtY(var1, var2, 0, 9);
   }

   public void centerAtYAll(GUI.CenterFormatType var1, int var2, int var3) {
   ...
   public void centerAtYAll(GUI.CenterFormatType var1) {
   ...
   public void centerAtX(int var1, GUI.CenterFormatType var2) {
      this.centerAtX(var1, var2, 0, this.getHeight());
   }

   public void centerAtXAll(GUI.CenterFormatType var1, int var2, int var3) {
      for(int var4 = 0; var4 < 9; ++var4) {
   ...
   public void centerAtXAll(GUI.CenterFormatType var1) {
   ...
   public static class AddItemFlag {
      ...
      public static GUI.AddItemFlag createWithinX(int var0, int var1) {
         GUI.AddItemFlag var2 = new GUI.AddItemFlag();
         var2.type = 0;
      ...
      public static GUI.AddItemFlag createWithinY(int var0, int var1) {
         GUI.AddItemFlag var2 = new GUI.AddItemFlag();
         var2.type = 1;
         var2.param = new Object[2];
         var2.param[0] = var0;
      ...
      public static GUI.AddItemFlag createWithin(int var0, int var1, int var2, int var3) {
         GUI.AddItemFlag var4 = new GUI.AddItemFlag();
         var4.type = 2;
      ...
      public static GUI.AddItemFlag createCenterizedHorizontal() {
         GUI.AddItemFlag var0 = new GUI.AddItemFlag();
         var0.type = 3;
         return var0;
      }
